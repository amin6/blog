    ...
    if(isset($_GET['id'])) {
        ...
        if(!empty($post)){
            ...
            if(isset($_POST['submit'])){
                ...
                $query = "UPDATE posts SET title='$title', tags='$tags', image='$post_image', content='$content' WHERE id=$id ";
                $result = mysqli_query($conn,$query);
            }
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <textarea name="content" id="" class="form-control" rows="10" style="margin-top:1.5rem"><?php echo $content; ?></textarea>
